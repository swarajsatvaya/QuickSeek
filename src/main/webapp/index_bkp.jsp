        ...
        <div class="bgded overlay main-header-slider"> 
            <div class="container">
                <header class="main-header-area free-listinghdr index-logo"> 
                    <div class="logo">
                        <a href="index.html"><img src="./resources/images/QckseekLogo.png"></a>
                    </div>
                                    ...
                                    <div class="acktypeselct">
                                        <form class="catagories-area">
                                            <ul>
                                                ...
                                                <li class="location-select padding-right">
                                                    <input type="search" placeholder="What are you looking for?" required="" />
                                                </li>
                                            </ul>
                                            <div class="searchbtn">
                                                <button type="submit"  onclick="location.href='./ownerList'">Search Now</button>
                                            </div>
                                        </form>
                                    </div>
                                                    ...
                                                    <div class="clients-carousel-wraper">
                                                        <div class="owl-carousel owl-theme owl-loaded automobiles">
                                                            <div class=" item imghvrzm">
                                                                <a href="#"> <img src="./resources/images/taxi.png" class="img-responsive" alt="car" title=""/><span>Car</span></a>
                                                            </div>
                                                            <div class=" item imghvrzm">
                                                                <a href="#"> <img src="./resources/images/library.png" class="img-responsive" alt="library" title=""/><span>Book</span></a>
                                                            </div>
                                                            <div class="item imghvrzm">
                                                                <a href="#"> <img src="./resources/images/laptop.png" class="img-responsive" alt="Computer" title=""/><span>Computer</span></a>
                                                            </div>
                                                            <div class="item imghvrzm">
                                                                <a href="#"> <img src="./resources/images/smartphone.png" class="img-responsive" alt="Mobile" title=""/><span>Mobile</span></a>
                                                            </div>
                                                            <div class="item imghvrzm">
                                                                <a href="#">  <img src="./resources/images/pets.png" class="img-responsive" alt="Pets" title=""/><span>Pets</span></a>
                                                            </div>
                                                            <div class="item imghvrzm">
                                                                <a href="#">  <img src="./resources/images/job.png" class="img-responsive" alt="job" title=""/><span>Job</span></a>
                                                            </div>
                                                            <div class="item imghvrzm">
                                                                <a href="#">  <img src="./resources/images/taxi.png" class="img-responsive" alt="car" title=""/><span>Car</span></a>
                                                            </div>
