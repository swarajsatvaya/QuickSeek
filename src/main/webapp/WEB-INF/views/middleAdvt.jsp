<%-- 
    Document   : middleAdvt
    Created on : Feb 24, 2017, 5:18:40 PM
    Author     : pc2
--%>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="block">
                                        ...
                                        <form class="form-horizontal" action="./uploadMiddleAdvt" method="POST" name="middleAdvtBean"  enctype="multipart/form-data">
                                            ...
                                            <input type="submit" class="btn btn-danger" value="ADD" id="addMiddleAdvt">
                                        </form>
                                    </div>
                                </div>
