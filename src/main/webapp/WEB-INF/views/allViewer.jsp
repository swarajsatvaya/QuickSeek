<%-- 
    Document   : allViewer
    Created on : Feb 14, 2017, 11:58:41 AM
    Author     : pc2
--%>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title-box">
                                        <h3>Viewer Account Manage</h3>
                                        <span>Manage All Brands Here</span>
                                    </div>
                ...
                $.ajax({url: "./getAllCustomer",
                    ...
                    success: function (result) {
                        ...
                        for (var i = 0; i < result.length; i++)
                        {
                            strVar += "<tr>";
                            strVar += "<td>" + (i + 1) + "<\/td>";
                            strVar += "<td>" + result[i].userId + "<\/td>";
                            strVar += "<td>" + result[i].name + "<\/td>";
                            strVar += "<td>" + result[i].mobileNo + "<\/td>";
                            strVar += "<td>" + result[i].emailId + "<\/td>";
                            strVar += "<td>" + result[i].address + "<\/td>";
                            strVar += "<td>" + result[i].login + "<\/td>";
                            strVar += "<td class=\"text-center\"><a href=\"./viewerDetails\" style=\" font-size:14px;\" title=\"View\" data-toggle=\"tooltip\" data-placement=\"top\"><span class=\"fa fa-eye\"><\/span><\/a><\/td>";
                            strVar += "<\/tr>";


                        }
                        $('#allCustomer tbody').html(strVar);
