<%-- 
    Document   : searchViewer
    Created on : Feb 14, 2017, 1:36:46 PM
    Author     : pc2
--%>
...
<html>
    <head>        
        ...
        <style>
            #viewtblshw{display: none}
            .permission-section ul{list-style-type: none; padding-left: 0; float: left; width: 100%;-webkit-column-count: 2; /* Chrome, Safari, Opera */
                -moz-column-count: 2; /* Firefox */
                column-count: 2;}
            .permission-section ul li{font-size: 13px;}
            .permission-section ul li input{float: left; margin-right: 5px}  
            @media (max-width: 767px){
                .permission-section ul{-webkit-column-count: 1; -moz-column-count: 1; column-count: 1;}
            }
        ...
        <body>
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="">
                        <a href="#"><span class="fa fa-file-o"></span> <span class="xn-text">Create User</span></a>
                    </li>
                    <li class="">
                        ...
                        <div class="block">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <form class="form-horizontal" method="post" id="backofficeempadd" name="backofficeEmployeeBean" action="./addBackEmp">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 permission-section">
                                                    <ul>
                                                        <li><input type="checkbox" name="managePages">Manage Pages</li>
                                                        <li><input type="checkbox" name="createUser">Create User</li>
                                                        <li><input type="checkbox" name="manageEmployee">Manage Employee</li>
                                                        <li><input type="checkbox" name="manageCustomer">Manage Customer Account</li>
                                                        <li><input type="checkbox" name="viewerList">All Viewer List</li>
                                                        <li><input type="checkbox" name="locationList">State-City Viewer List</li>
                                                        <li><input type="checkbox" name="manageLocation">Manage Location</li>
                                                        <li><input type="checkbox" name="manageCategories">Manage Categories</li>
                                                        <li><input type="checkbox" name="keywords">Manage Keyword</li>
                                                        <li><input type="checkbox" name="adManagement">Ad Management</li>
                                                        <li><input type="checkbox" name="customerSupport">Customer Support</li>
                                                        <li><input type="checkbox" name="manageReports">Manage Reports</li>
                                                        <li><input type="checkbox" name="adPackage">Manage Accounts</li>
                                                        <li><input type="checkbox" name="manageAc">Manage Ad Package</li>
                                                        <li><input type="checkbox" name="feedback">Customer FeedBack</li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="submit" name="addStaff" class="btn btn-success" >
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                    ...
                                    <br />
                                    <div class="col-md-12">
                                        <table class="table tableanckr" id="allCustomer">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Designation</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>6033</td>
                                                    <td>Rohan Bose</td>
                                                    <td class="text-center"><a href="./viewerDetails" style=" font-size:14px;" title="View" data-toggle="tooltip" data-placement="top"><span class="fa fa-eye"></span></a></td>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <script>
            $(document).ready(function () {
                $("#viewerbtnclck").click(function () {
                    $("#viewtblshw").slideToggle('slow');
                });
            });
        </script>
