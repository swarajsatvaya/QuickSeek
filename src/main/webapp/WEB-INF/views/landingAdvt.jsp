<%-- 
    Document   : landingAdvt
    Created on : Feb 22, 2017, 12:15:17 PM
    Author     : pc2
--%>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="block">
                                        ...
                                        <form class="form-horizontal" action="./uploadLandingAdvt" method="POST" name="landingAdvtBean"  enctype="multipart/form-data">
                                            <div class="form-group">
                                                <div class="col-md-10 landinggrid">
                                                    <input type="file" name="advt" class="upldlandnginput" accept="image/*" title="Select Image" id="advt">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-10 landinggrid">
                                                    <input type="file" name="advtOne" class="upldlandnginput" accept="image/*" title="Select Image" id="advtOne">
                                                    <label><strong>Image Resolution:</strong> XXXpx x XXXpx</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-10 landinggrid">
                                                    <input type="file" name="advtTwo" class="upldlandnginput" accept="image/*" title="Select Image" id="advtTwo">
                                                    <label><strong>Image Resolution:</strong> XXXpx x XXXpx</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-10 landinggrid">
                                                    <input type="file" name="advtThree" class="upldlandnginput" accept="image/*" title="Select Image" id="advtThree">
                                                    <label><strong>Image Resolution:</strong> XXXpx x XXXpx</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-10 landinggrid">
                                                    <input type="file" name="advtFour" class="upldlandnginput" accept="image/*" title="Select Image" id="advtFour">
                                                    <label><strong>Image Resolution:</strong> XXXpx x XXXpx</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-10 landinggrid">
                                                    <input type="file" name="advtFive" class="upldlandnginput" accept="image/*" title="Select Image" id="advtFive">
                                                    <label><strong>Image Resolution:</strong> XXXpx x XXXpx</label>
                                                </div>
                                            </div>
                                            
                                            <input type="submit" class="btn btn-danger" value="ADD" id="addLandAdvt">
                                        </form>
                                    </div>
                                </div>
