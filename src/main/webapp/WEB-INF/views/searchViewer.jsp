                                        ...
                                        <form class="form-horizontal">
                                            <div class="col-xs-12 col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="" style=" height:33px;">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <div class="col-md-12 text-right" style="margin-top: 10px">
                                                        <button type="button" id="viewerbtnclck" class="btn btn-success viewerstatebtn">Submit</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="panel-body ciewer-tablepdng" id="viewtblshw">
                                        <div class="col-md-12">
                                            <table class="table tableanckr datatable_simple">
                                                <thead>
                                                    <tr>
                                                        <th>Id</th>
                                                        <th>Name</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Xxxx</td>
                                                        <td>Xxxx</td>
                                                        <td class="text-center"><a href="viewer-list.html" style=" font-size:14px;" title="View" data-toggle="tooltip" data-placement="top"><span class="fa fa-eye"></span></a></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Xxxx</td>
                                                        <td>Xxxx</td>
