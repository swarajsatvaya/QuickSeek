<%-- 
    Document   : manage-view-category
    Created on : Jan 27, 2017, 11:39:43 AM
    Author     : pc2
--%>
...
<html>
    <head>        
        <!-- META SECTION -->
        <title>QckSeek | Category View</title>            
...
<!--                    <li class="">
                ...
                <div class="page-content-wrap">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-md-6">
                                    <div class="block">
                                        <h4>Add Category</h4>                                
                                        <form class="form-horizontal" method="post" id="categoryadd" name="categoryBean" action="./addcategory">
                                            <div class="form-group">
                                                <div class="col-md-10">
                                                    <input type="file" name="image" class="" accept="image/*" title="Select Image" id="image">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-10">
                                                    <input type="text" name="icon" class="form-control" placeholder="Icon Code" id="icon">
                                                    <a href="https://fortawesome.github.io/Font-Awesome/icons/" target="_blank">Search Color Code</a>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-10">
                                                    <input type="text" name="color" class="form-control jscolor" placeholder="Color Code"  id="color">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-10">
                                                    <input type="text" name="name" class="form-control" size="40" placeholder="Category Name" id="name">
                                                </div>
                                            </div>
                                            <input type="submit" class="btn btn-danger" value="ADD" id="addCategory">
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="block">
                                        ...
                                        <form class="form-horizontal" method="post" id="addSubcat">

                                            <div class="form-group">
                                                <div class="col-md-10">
                                                    <!-- <input type="file" name="simage" class="fileinput" accept="image/*" title="Select Image"> -->
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-md-10">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-10">
                                                    <input type="text" name="name" class="form-control" size="45" placeholder="Sub Category Name" id="subcatname">
                                                </div>
                                            </div>
                                            <input type="submit" name="addSubcategory" class="btn btn-danger" value="ADD" id="addSubcategory">
                                        </form> 
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6" >
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table class="table" id="allSubcat">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Category Name</th>
        ...
        <script type="text/javascript">
                                                ...
                                                $.ajax({url: "./loadAllCatagory",
                                                    ...
                                                    success: function (result) {
                                                        ...
                                                        for (var i = 0; i < result.length; i++) {
                                                            ...
                                                            strVar += "<\/td>";
                                                            strVar += "<td>";
                                                            strVar += " <a onclick=\"updateCategoryStatus('" + result[i].id + "," + result[i].status + "')\"  style=\"color:red; font-size:14px;cursor: pointer;\" data-toggle=\"tooltip\" data-placement=\"top\"><span class=\"fa fa-ban\"><\/span><\/a>";
                                                            strVar += " &nbsp;&nbsp;&nbsp;&nbsp;";
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (response) {
                                                        if (response.status === 1) {
                                                            swal("Success!", "Successfully Update Category status", "success");
                                            ...
                                            function getSubcategory() {
                                                $.ajax({
                                                    url: "./loadAllSubCategory",
                                                    method: "get",
                                                    success: function (result) {
                                                        console.log(result);
                                                        $('#allSubcat tbody').html("");
                                                        var strVar = "";
                                                        for (var i = 0; i < result.length; i++) {

                                                            strVar += "<tr>";
                                                            strVar += "<td>" + (i + 1) + "<\/td>";
                                                            strVar += "<td>" + result[i].categoryBean.name + "<\/td>";
                                                            strVar += "<td>" + result[i].name + "<\/td>";
                                                            strVar += " <td >";
                                                            strVar += result[i].status;
                                                            strVar += "<\/td>";
                                                            strVar += "<td>";
                                                            strVar += " <a onclick=\"updateSubcategoryStatus('" + result[i].id + "," + result[i].status + "')\"  style=\"color:red; font-size:14px;cursor: pointer;\" data-toggle=\"tooltip\" data-placement=\"top\"><span class=\"fa fa-ban\"><\/span><\/a>";
                                                            strVar += "&nbsp;&nbsp;&nbsp;&nbsp;";
                                                            strVar += "<a href=\"#\" title=\"Edit\"  style=\"font-size:14px;\" data-toggle=\"tooltip\" data-placement=\"top\"><span class=\"fa fa-edit\"><\/span><\/a>";
                                                            strVar += "&nbsp;&nbsp;&nbsp;&nbsp;";
                                                            strVar += "<a href=\"#\" title=\"Delete\"  style=\"color:red; font-size:14px;\" data-toggle=\"tooltip\" data-placement=\"top\" onclick=\"return deleteData();\"><span class=\"fa fa-trash-o\"><\/span><\/a>";
                                                            strVar += "<\/td>";
                                                            strVar += "<\/tr>";

                                                        }
                                                        $('#allSubcat tbody').html(strVar);
                                                    }
                                                });
                                            }
                                            ...
                                            function updateSubcategoryStatus(id) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (response) {
                                                        if (response.status === 1) {
                                                            swal("Success!", "Successfully Update Subcategory status", "success");
                                                            window.location = "../admin/category";
                                                        } else {
                                                            swal("Oops...", "Please try again later", "error");
                                                        }
                                            ...
                                            $(document).ready(function () {
                                                ...
                                                $('#addSubcategory').click(function () {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        {
                                                            if (response.status === 1) {
                                                                swal("Success!", "Successfully added Subcategory name", "success")
                                                                window.location = "../admin/category";
                                                            } else {
                                                                swal("Oops...", "Subcategory Type already exist", "error");
                                                            }
                                                        },
                                                        data: sendInfo
                                                    });
