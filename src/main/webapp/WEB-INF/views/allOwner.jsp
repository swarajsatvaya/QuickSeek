<%-- 
    ...
    Created on : Feb 21, 2017, 12:35:15 PM
    Author     : pc2
--%>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            ...
                                            <div class="btn-group pull-right">
                                                <button type="submit" value="publish" name="userAllow" id="allowuser" class="btn btn-success"> Allow</button>
                                                <a  name="userDelete" id="deleteuser" class="btn btn-danger"> Delete</a>
                                            </div>
                                        </div>
                                        <div class="panel-body">
                                            <table class="table tableanckr" id="allOwner">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Name</th>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel">Viewer List</h4>
                            </div>
        ...
        <script type="text/javascript">
                ...
                $.ajax({url: "./getAllOwner",
                    ...
                    success: function (result) {
                        ...
                        for (var i = 0; i < result.length; i++)
                        {
                            ...
                            strVar += "<td>" + result[i].companyName + "<\/td>";
                            strVar += "<td>" + result[i].state + "<\/td>";
                            strVar += "<td>" + result[i].contactNo + "<\/td>";
                            strVar += "<td>" + result[i].status + "<\/td>";
                            strVar += "<td class=\"text-center\"><a href=\"#\" style=\" font-size:14px;\" title=\"Upgrade\" data-toggle=\"tooltip\" data-placement=\"top\"><img src=\"..\/resources\/images\/upgrade.png\" alt=\"Upgrade\" \/><\/a><\/td>";
                            strVar += "<\/tr>";


                        }
                        $('#allOwner tbody').html(strVar);
            ...
            $('#allowuser').click(function () {
                $('.singlecheck2').each(function () {
                    if ($(this).is(':checked')) {
                        updateOwnerStatus($(this).val());
                        //alert($(this).val());
                    }
                });
            });
            function updateOwnerStatus(id) {
                //alert(id);
                var sendInfo = {
                    ownerid: id
                };
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status === 1) {
                            swal("Success!", "Successfully Update owner status", "success");
                            //window.location = "../admin/allOwner";
                        } else {
